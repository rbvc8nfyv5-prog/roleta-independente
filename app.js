...
/*
   SEM JOGADA NÃO PARTICIPA
   DO DIAGNÓSTICO DE LOSS.
*/
...
/*
   Se naquele ponto do backtest
   não existia jogada, registra —.
*/
...
/*
   Snapshot não corresponde ao
   estado atual.

   Também não transforma em LOSS.
*/
